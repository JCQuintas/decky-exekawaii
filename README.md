...
│   └── components/
│       ├── CommandList.tsx    # Main command list view
│       ├── CommandItem.tsx    # Individual command display
│       ├── CommandEditor.tsx  # Command creation/editing form
│       └── ConfigPanel.tsx    # Configuration field rendering
├── main.py                # Python backend
├── plugin.json            # Plugin metadata
└── examples/              # Example command configurations
```
